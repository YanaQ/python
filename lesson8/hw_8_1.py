...
# с декоратором @staticmethod, должен проводить валидацию числа, месяца и года (например, месяц — от 1 до
...
print(today.valid(1, 15, 2020))
print(today.valid(33, 12, 2020))
print(Data.extract('11 - 11 - 2011'))
print(today.extract('1 - 12 - 2020'))
print(Data.valid(1, 12, 2020))